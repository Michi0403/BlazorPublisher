...
CSS_MARKERS = ('publisherstudio-theme-control', 'publisherstudio-kawaii-sky', 'publisherstudio-cursor-paw', 'publisherstudio-mobile-navigation')
JS_MARKERS = ('mountThemeControl', 'ensureSnapshotMobileNavigation', 'publisherstudio-docs-theme', 'persistTheme', 'publisherstudio-cursor-paw')
