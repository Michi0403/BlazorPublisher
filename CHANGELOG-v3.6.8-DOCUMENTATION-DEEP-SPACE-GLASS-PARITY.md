# PublisherStudio 3.6.8 — Documentation deep-space glass parity

PublisherStudio 3.6.8 refines the Kawaii documentation shell shared with LocalGPT.
...
The editor/runtime behavior outside documentation styling is unchanged from 3.6.7.
