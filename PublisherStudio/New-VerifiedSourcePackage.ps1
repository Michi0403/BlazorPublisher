...
try {
    Get-ChildItem -LiteralPath $repositoryRoot -Recurse -File -Force |
        Where-Object {
            ...
            $excludedDirectory = $relative -match '(^|/)(\.git|\.vs|\.cr|node_modules|artifacts|bin|obj|AppPackages|BundleArtifacts)(/|$)' -or $relative -match '^PublisherStudio/docs/(_site|input|api|\.tools|\.print-book)(/|$)'
