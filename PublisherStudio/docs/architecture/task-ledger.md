...
| v2.0.4 service-owned compiler and BusinessObjects repair | Closed at source-contract baseline | Migrates data contracts to `PublisherStudio.BusinessObjects`, restores DI-owned factories and startup logging, fixes InteractiveServer imports and semantically validates release mappings. Native Windows/DevExpress build evidence remains maintainer-run. |
