...
rem Runtime files are merged in place; this setup folder is replaced after the current process exits.
call "%SETUP_EXE%" --update-blazorpublisher --install-ffmpeg --start-blazorpublisher --port 58071 --shortcuts
