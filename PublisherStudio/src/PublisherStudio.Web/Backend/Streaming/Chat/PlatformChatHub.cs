...
namespace PublisherStudio.Backend.Streaming.Chat;
...
public sealed class PlatformChatHub : IAsyncDisposable
{
    ...
    public PlatformChatHub(MediaSession session) => _session = session;
