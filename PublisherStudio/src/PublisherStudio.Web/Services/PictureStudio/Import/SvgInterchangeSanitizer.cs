...
public static class SvgInterchangeSanitizer
{
    ...
    public static (double Width, double Height, double MinX, double MinY) ReadViewport(string svg)
    {
    ...
    public static double ParseLength(string? value, double fallback = 0)
    {
    ...
    private static bool ContainsExternalCssReference(string value)
    {
    ...
    private static bool IsExternalReference(string localName, string value)
    {
    ...
    private static double[] ParseNumbers(string? value, int maximum)
    {
