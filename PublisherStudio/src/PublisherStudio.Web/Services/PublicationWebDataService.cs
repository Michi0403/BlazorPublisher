...
public sealed class PublicationWebDataService
{
    ...
    public PublicationWebDataService(
        ...
        ILogger<PublicationWebDataService> logger)
    {
        try
        {
        ...
        {
            logger.LogError(exception, $"Publication web data service initialization failed: {exception.Message}");
            throw;
        }
    }
    ...
    public async Task RefreshAsync(PublicationDataObject dataObject, CancellationToken cancellationToken = default)
    {
        try
        {
            logger.LogTrace($"Entering PublicationWebDataService.RefreshAsync.");
        ...
        {
            logger.LogError(exception, $"PublicationWebDataService.RefreshAsync failed: {exception.Message}");
            throw;
        }
    }
    ...
    public bool IsDue(PublicationDataObject dataObject, DateTimeOffset now)
    {
        try
        {
            logger.LogTrace($"Entering PublicationWebDataService.IsDue.");
        ...
        {
            logger.LogError(exception, $"PublicationWebDataService.IsDue failed: {exception.Message}");
            throw;
        }
    }
    ...
    private Uri ResolveUri(string value, PublicationWebTransportKind transport)
    {
        try
        {
            logger.LogTrace($"Entering PublicationWebDataService.ResolveUri.");
                    ...
                    var baseUrl = _runtimeEndpointState.BaseUrl;
        ...
        {
            logger.LogError(exception, $"PublicationWebDataService.ResolveUri failed: {exception.Message}");
            throw;
        }
    }
    ...
    private HttpMethod ToHttpMethod(PublicationWebHttpMethod method) {
        try
        {
            logger.LogTrace($"Entering PublicationWebDataService.ToHttpMethod.");
            return method switch
    {
        ...
        {
            logger.LogError(exception, $"PublicationWebDataService.ToHttpMethod failed: {exception.Message}");
            throw;
        }
    }
    ...
    private string TrimForError(string value)
    {
        try
        {
            logger.LogTrace($"Entering PublicationWebDataService.TrimForError.");
        ...
        {
            logger.LogError(exception, $"PublicationWebDataService.TrimForError failed: {exception.Message}");
            throw;
        }
    }
}
