...
assert.match(componentRuntime, /onReady\(\)\s*\{\s*try\s*\{\s*element\.__psMapReady = true;/);
assert.match(componentRuntime, /onDrawn\(\)\s*\{\s*try\s*\{\s*element\.__psMapReady = true;/);
