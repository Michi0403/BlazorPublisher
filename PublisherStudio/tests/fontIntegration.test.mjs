...
assert.match(webProject, /<Version>1\.0\.66<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.66<\/Version>/);
assert.equal(packageJson.version, '1.0.66');
assert.match(runtimeCapabilities, /Version = "1\.0\.66"/);
