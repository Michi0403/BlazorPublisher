...
assert.match(webProject, /<Version>1\.0\.71<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.71<\/Version>/);
assert.equal(packageJson.version, '1.0.71');
assert.match(runtimeCapabilities, /Version = "1\.0\.71"/);
