...
assert.match(webProject, /<Version>1\.0\.67<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.67<\/Version>/);
assert.equal(packageJson.version, '1.0.67');
assert.match(runtimeCapabilities, /Version = "1\.0\.67"/);
