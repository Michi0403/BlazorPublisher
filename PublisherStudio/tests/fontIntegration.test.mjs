...
assert.match(webProject, /<Version>1\.0\.65<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.65<\/Version>/);
assert.equal(packageJson.version, '1.0.65');
assert.match(runtimeCapabilities, /Version = "1\.0\.65"/);
