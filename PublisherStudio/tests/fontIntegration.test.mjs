...
assert.match(webProject, /<Version>1\.0\.56<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.56<\/Version>/);
assert.equal(packageJson.version, '1.0.56');
assert.match(runtimeEndpoints, /version = "1\.0\.56"/);
