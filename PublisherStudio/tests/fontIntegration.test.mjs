...
assert.match(webProject, /<Version>1\.0\.70<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.70<\/Version>/);
assert.equal(packageJson.version, '1.0.70');
assert.match(runtimeCapabilities, /Version = "1\.0\.70"/);
