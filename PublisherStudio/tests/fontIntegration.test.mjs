...
assert.match(webProject, /<Version>1\.0\.69<\/Version>/);
assert.match(installerProject, /<Version>1\.0\.69<\/Version>/);
assert.equal(packageJson.version, '1.0.69');
assert.match(runtimeCapabilities, /Version = "1\.0\.69"/);
