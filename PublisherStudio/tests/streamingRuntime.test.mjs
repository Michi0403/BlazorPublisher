...
const mediaSession = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Sessions', 'MediaSession.cs'), 'utf8');
const hotkeys = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'HostedServices', 'Streaming', 'GlobalHotkeyService.cs'), 'utf8');
const nowPlaying = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Metadata', 'NowPlayingReader.cs'), 'utf8');
const streamingComposition = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Services', 'Streaming', 'StreamingServiceCollectionExtensions.cs'), 'utf8');
...
const encoder = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Encoding', 'EncoderOrchestrator.cs'), 'utf8');
const lanServer = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Lan', 'LanStreamingServer.cs'), 'utf8');
const nativeCapture = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Capture', 'NativeCaptureRegistry.cs'), 'utf8');
const nativeDevices = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Capture', 'NativeDeviceDiscovery.cs'), 'utf8');
const platformChat = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Chat', 'PlatformChatHub.cs'), 'utf8');
const rtspServer = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Lan', 'RtspLanServer.cs'), 'utf8');
const webRtcHub = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Lan', 'WebRtcSignalingHub.cs'), 'utf8');
const processLoopback = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Capture', 'WindowsProcessLoopbackCapture.cs'), 'utf8');
...
const ffmpegLocator = fs.readFileSync(path.join(root, 'src', 'PublisherStudio.Web', 'Backend', 'Streaming', 'Encoding', 'FfmpegLocator.cs'), 'utf8');
...
assert.match(runtimeUseCases, /Version = "1\.0\.62"/);
