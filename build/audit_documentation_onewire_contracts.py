...
require('src/PublisherStudio.Web/Components/Pages/OrganicPlugins.razor','Method and route','Configuration','Runtime','MaximumMessageBytes','PeerExpirySeconds','AutoConnectDiscoveredPeer','RemoteCapabilities','OrganicWireMessageType.Ping','OrganicWireMessageType.Pong','/api/organic/onewire/http-json/profile')
