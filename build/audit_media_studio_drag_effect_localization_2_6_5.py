...
try:
    ...
    require('src/PublisherStudio.Web/Components/Editor/MediaStudio.razor',
            ...
            './js/mediaStudioInterop.js?v=2.6.9')
    ...
    require('src/PublisherStudio.Web/Components/App.razor',
            'videoEffectRuntime.js?v=2.6.5', 'publisherInterop.js?v=2.6.9')
    require('src/PublisherStudio.Web/PublisherStudio.Web.csproj', '<Version>2.6.9</Version>')
    require('src/PublisherStudio.InstallerConsole/PublisherStudio.InstallerConsole.csproj', '<Version>2.6.9</Version>')
