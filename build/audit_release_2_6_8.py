...
try:
    require('src/PublisherStudio.Web/PublisherStudio.Web.csproj','<Version>2.7.8</Version>')
    require('src/PublisherStudio.InstallerConsole/PublisherStudio.InstallerConsole.csproj','<Version>2.7.8</Version>')
    ...
    require('src/PublisherStudio.Web/Components/Editor/MediaStudio.razor',
            '"media-studio-sequence-timeline",', './js/mediaStudioInterop.js?v=2.7.8')
