...
try:
    ...
    require("src/PublisherStudio.Web/Components/App.razor", "css/site.css?v=20260818-282", "videoEffectRuntime.js?v=2.8.2", "publisherInterop.js?v=2.8.2")
    for rel in (
        "src/PublisherStudio.Web/Components/Pages/Editor.razor",
        "src/PublisherStudio.Web/Components/Editor/MediaStudio.razor",
        "src/PublisherStudio.Web/Components/Editor/InspectorPanel.razor",
    ):
        require(rel, "mediaStudioInterop.js?v=2.8.2")
