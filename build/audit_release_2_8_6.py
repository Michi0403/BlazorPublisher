#!/usr/bin/env python3
"""Static source audit for PublisherStudio 2.9.0 compile/text-ownership repair."""
...
try:
    ...
    print(f'PublisherStudio 2.9.0 compile/text-ownership source audit passed: {checks} checks.')
