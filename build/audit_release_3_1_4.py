...
major, minor, patch = (3, 1, 4)
if minor > 9 or patch > 9:
    errors.append("release version violates the one-digit minor/patch slot policy")
require("src/PublisherStudio.Web/package.json", '"version": "3.1.4"')
require("src/PublisherStudio.Web/package-lock.json", '"version": "3.1.4"')
require("RELEASE.md", "CHANGELOG-v3.1.4-SHARED-LOCALGPT-PACKAGING-RELEASE-RESTORE.md")
require("RELEASE.md", "VALIDATION-v3.1.4-source.md")
text("CHANGELOG-v3.1.4-SHARED-LOCALGPT-PACKAGING-RELEASE-RESTORE.md")
text("VALIDATION-v3.1.4-source.md")
require("docs/docfx.json", '"publisherstudioVersion": "3.1.4"')
require("docs/pdf/toc.yml", "PublisherStudio-3.1.4.pdf")
...
if errors:
    print("PublisherStudio 3.1.4 static release audit FAILED:")
    for error in errors:
        print(" -", error)
    raise SystemExit(1)
print("PublisherStudio 3.1.4 static release audit passed.")
