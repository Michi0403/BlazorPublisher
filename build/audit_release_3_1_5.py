...
require("src/PublisherStudio.Web/package.json", '"version": "3.1.5"')
require("src/PublisherStudio.Web/package-lock.json", '"version": "3.1.5"')
require("RELEASE.md", "CHANGELOG-v3.1.5-SHARED-PACKAGING-PIPELINE-CONTRACT.md")
require("RELEASE.md", "VALIDATION-v3.1.5-source.md")
text("CHANGELOG-v3.1.5-SHARED-PACKAGING-PIPELINE-CONTRACT.md")
text("VALIDATION-v3.1.5-source.md")
require("docs/docfx.json", '"publisherstudioVersion": "3.1.5"')
require("docs/pdf/toc.yml", "PublisherStudio-3.1.5.pdf")
...
if errors:
    print("PublisherStudio 3.1.5 static release audit FAILED:")
    for error in errors:
        print(" -", error)
    raise SystemExit(1)
print("PublisherStudio 3.1.5 static release audit passed.")
