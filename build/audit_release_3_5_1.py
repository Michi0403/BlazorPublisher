#!/usr/bin/env python3
"""Source-only release checks for PublisherStudio 3.5.1."""
...
for rel, needle in (
    ...
    ("CHANGELOG-v3.5.1-MACOS-UPDATER-RUNTIME-IDENTITY.md", "macOS updater"),
    ("VALIDATION-v3.5.1-source.md", "# PublisherStudio 3.5.1 source validation"),
):
    require(rel, needle)
...
# 3.5.1 release source identity prevents same-version stale artifacts.
...
if ERRORS:
    print("PublisherStudio 3.5.1 source audit FAILED:")
    for error in ERRORS:
        print(f" - {error}")
    sys.exit(1)
print(
    ...
    "PowerShell 5.1 documentation repair and macOS runtime/update identity guarded."
)
