#!/usr/bin/env python3
"""Source-only release checks for PublisherStudio 3.5.2."""
...
for rel, needle in (
    ...
    ("CHANGELOG-v3.5.2-RELEASE-PARSER-RENDEZVOUS-REPAIR.md", "PowerShell release parser repair"),
    ("VALIDATION-v3.5.2-source.md", "# PublisherStudio 3.5.2 source validation"),
):
    require(rel, needle)
...
# 3.5.2 release parser and source identity prevent stale artifacts.
...
if ERRORS:
    print("PublisherStudio 3.5.2 source audit FAILED:")
    for error in ERRORS:
        print(f" - {error}")
    sys.exit(1)
print(
