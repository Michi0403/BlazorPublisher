...
version("src/PublisherStudio.Web/PublisherStudio.Web.csproj", "3.5.8")
version("src/PublisherStudio.InstallerConsole/PublisherStudio.InstallerConsole.csproj", "3.5.8")
require("src/PublisherStudio.Web/package.json", '"version": "3.5.8"')
require("src/PublisherStudio.Web/package-lock.json", '"version": "3.5.8"')
require("docs/docfx.json", '"publisherstudioVersion": "3.5.8"')
require("CHANGELOG-v3.5.8-INSTALLER-COMPILE-LOGGING-INTEGRITY-REPAIR.md", "3.5.8")
require("VALIDATION-v3.5.8-source.md", "3.5.8")
require("RELEASE.md", "PublisherStudio 3.5.8")
...
if failures:
    print("PublisherStudio 3.5.8 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)

print("PublisherStudio 3.5.8 release audit passed: installer compile surface, one-digit version rule, maintained logging baseline, shared single-writer sink, renderer-affinity guard, overlay installer contract, and early installer preflight are intact.")
