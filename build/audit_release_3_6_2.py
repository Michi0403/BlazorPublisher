...
version("src/PublisherStudio.Web/PublisherStudio.Web.csproj", "3.6.2")
version("src/PublisherStudio.InstallerConsole/PublisherStudio.InstallerConsole.csproj", "3.6.2")
for relative, token in (
    ("src/PublisherStudio.Web/package.json", '"version": "3.6.2"'),
    ("src/PublisherStudio.Web/package-lock.json", '"version": "3.6.2"'),
    ("docs/docfx.json", '"publisherstudioVersion": "3.6.2"'),
    ("docs/pdf-cover.html", "PublisherStudio 3.6.2 Documentation"),
    ("docs/index.md", "**Version 3.6.2**"),
    ...
    ("RELEASE.md", "PublisherStudio 3.6.2"),
):
...
if failures:
    print("PublisherStudio 3.6.2 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("PublisherStudio 3.6.2 release audit passed: adaptive low-memory DocFX/PDF policy is guarded while logging, overlay deployment, 3.6.1 Matrix installer control and 3.6.0 macOS signing/PDF protections remain intact.")
