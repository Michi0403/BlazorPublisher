...
version("src/PublisherStudio.Web/PublisherStudio.Web.csproj", "3.6.3")
version("src/PublisherStudio.InstallerConsole/PublisherStudio.InstallerConsole.csproj", "3.6.3")
for relative, token in (
    ("src/PublisherStudio.Web/package.json", '"version": "3.6.3"'),
    ("src/PublisherStudio.Web/package-lock.json", '"version": "3.6.3"'),
    ("docs/docfx.json", '"publisherstudioVersion": "3.6.3"'),
    ("docs/pdf-cover.html", "PublisherStudio 3.6.3 Documentation"),
    ("docs/index.md", "**Version 3.6.3**"),
    ("docs/pdf/toc.yml", "PublisherStudio-3.6.3.pdf"),
    ("src/PublisherStudio.Web/Components/App.razor", "publisherInterop.js?v=3.6.3"),
    ...
    ("src/PublisherStudio.Web/Components/Pages/Editor.razor", "?v=3.6.3"),
    ("src/PublisherStudio.Web/Components/Editor/BarcodeEditor.razor", "?v=3.6.3"),
    ("src/PublisherStudio.Web/Components/Editor/PageSurface.razor", "?v=3.6.3"),
    ("src/PublisherStudio.Web/Components/Editor/MediaStudio.razor", "?v=3.6.3"),
    ("src/PublisherStudio.Web/Components/Editor/WordArtPathEditor.razor", "?v=3.6.3"),
    ("src/PublisherStudio.Web/Components/Editor/InspectorPanel.razor", "?v=3.6.3"),
    ("RELEASE.md", "PublisherStudio 3.6.3"),
):
...
if failures:
    print("PublisherStudio 3.6.3 release audit FAILED:")
    print("\n".join(f" - {failure}" for failure in failures))
    sys.exit(1)
print("PublisherStudio 3.6.3 release audit passed: bounded browser chunk recovery and no-monolithic-fallback policy are guarded while adaptive low-memory documentation, logging, overlay deployment, Matrix installer control and macOS signing/PDF protections remain intact.")
