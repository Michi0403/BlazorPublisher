...
/// <summary>Provides the dependency-light Matrix-style operator layer used while PUBLISHERSTUDIO SETUP setup work is running.</summary>
internal static class SetupOperatorConsole
{
    ...
    {
        WriteMatrixLine("┌─ PUBLISHERSTUDIO SETUP // MATRIX OPERATOR ─────────────────────────────────────────────┐", ConsoleColor.Green);
