...
internal static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        Console.WriteLine("PublisherStudio Setup 2.2.2");
        ...
        long? expectedSize)
    {
        ...
        for (var attempt = 1; attempt <= maxAttempts; attempt++)
        {
            try
            {
                ...
                using var request = new HttpRequestMessage(HttpMethod.Get, url);
                request.Headers.UserAgent.ParseAdd("PublisherStudioSetupTool/2.2.2");
    ...
    private static HttpClient CreateHttpClient()
    {
        try
        {
            ...
            client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("PublisherStudioSetupTool", "2.2.2"));
