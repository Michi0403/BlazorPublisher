    ...
    ILogger<PanelDocumentService>? logger = null)
{
    ...
    catch (Exception __serviceMethodException)
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateVisual)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateVisual)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateComponent)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateComponent)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(NormalizePanel)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(NormalizePanel)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(NormalizeElements)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(NormalizeElements)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(EnsureUniqueId)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(EnsureUniqueId)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateKpiDashboard)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateKpiDashboard)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateOperationsBoard)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateOperationsBoard)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateCreatorHub)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateCreatorHub)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateWebExperience)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(CreateWebExperience)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(WebView)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(WebView)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(EnsureData)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(EnsureData)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(Visual)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(Visual)} failed.");
        throw;
    }
}
    ...
    {
        if (__serviceMethodException is OperationCanceledException)
            logger.LogDebug(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(Slug)} was canceled.");
        else
            logger.LogError(__serviceMethodException, $"Service method {nameof(PanelDocumentService)}.{nameof(Slug)} failed.");
        throw;
    }
}
}
